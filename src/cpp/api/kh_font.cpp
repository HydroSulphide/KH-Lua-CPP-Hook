...
const std::unordered_map<uint8_t, wchar_t> c_to_kh = {
	{0x1, L' '},
	{0x2, L'\n'},
	{0x20, L'▮'},
	{0x21, L'0'},
	...
	{0x23, L'2'},
	{0x24, L'3'},
	{0x25, L'4'}, {0x26, L'5'}, {0x27, L'6'}, {0x28, L'7'}, {0x29, L'8'}, {0x2A, L'9'}, {0x2B, L'A'}, {0x2C, L'B'}, {0x2D, L'C'}, {0x2E, L'D'}, {0x2F, L'E'}, {0x30, L'F'}, {0x31, L'G'}, {0x32, L'H'}, {0x33, L'I'}, {0x34, L'J'}, {0x35, L'K'}, {0x36, L'L'}, {0x37, L'M'}, {0x38, L'N'}, {0x39, L'O'}, {0x3A, L'P'}, {0x3B, L'Q'}, {0x3C, L'R'}, {0x3D, L'S'}, {0x3E, L'T'}, {0x3F, L'U'}, {0x40, L'V'}, {0x41, L'W'}, {0x42, L'X'}, {0x43, L'Y'}, {0x44, L'Z'}, {0x45, L'a'}, {0x46, L'b'}, {0x47, L'c'}, {0x48, L'd'}, {0x49, L'e'}, {0x4A, L'f'}, {0x4B, L'g'}, {0x4C, L'h'}, {0x4D, L'i'}, {0x4E, L'j'}, {0x4F, L'k'}, {0x50, L'l'}, {0x51, L'm'}, {0x52, L'n'}, {0x53, L'o'}, {0x54, L'p'}, {0x55, L'q'}, {0x56, L'r'}, {0x57, L's'}, {0x58, L't'}, {0x59, L'u'}, {0x5A, L'v'}, {0x5B, L'w'}, {0x5C, L'x'}, {0x5D, L'y'}, {0x5E, L'z'}, {0x5F, L'!'}, {0x60, L'?'}, {0x61, L'&'}, {0x62, L'%'}, {0x63, L'+'}, {0x64, L'-'}, {0x65, L'×'}, {0x66, L'/'}, {0x67, L'*'}, {0x68, L'.'}, {0x69, L','}, {0x6A, L'•'}, {0x6B, L':'}, {0x6C, L';'}, {0x6D, L'…'}, {0x6E, L'−'}, {0x6F, L'–'},
													  {0x70, L'~'}, {0x71, L'\''}, {0x72, L'“'}, {0x73, L'„'}, {0x74, L'('}, {0x75, L')'}, {0x76, L'['}, {0x77, L']'}, {0x78, L'〈'}, {0x79, L'⟩'}, {0x7A, L'★'}, {0x7B, L'☆'}, {0x7C, L'↑'}, {0x7D, L'↓'}, {0x7E, L'→'}, {0x7F, L'←'}, {0x80, L'●'}, {0x81, L'■'}, {0x82, L''}, {0x83, L''}, {0x84, L''}, {0x85, L''}, {0x86, L''}, {0x87, L''}, {0x88, L''}, {0x89, L''}, {0x8A, L''}, {0x8B, L''}, {0x8C, L''}, {0x8D, L''}, {0x8E, L''}, {0x8F, L''}, {0x90, L'▲'}, {0x91, L'▼'}, {0x92, L'▶'}, {0x93, L'◀'}, {0x94, L''}, {0x95, L''}, {0x96, L''}, {0x97, L''}, {0x98, L''}, {0x99, L''}, {0x9A, L''}, {0x9B, L''}, {0x9C, L''}, {0x9D, L''}, {0x9E, L'▢'}, {0x9F, L''}, {0xA0, L''}, {0xA1, L''}, {0xA2, L''}, {0xA3, L''}, {0xA4, L''}, {0xA5, L''}, {0xA6, L''}, {0xA7, L''}, {0xA8, L'⋯'}, {0xA9, L'®'}, {0xC4, L'Ⅲ'}, {0xC5, L'Ⅶ'}, {0xC6, L'Ⅷ'}, {0xC7, L'Ⅹ'}, {0xC8, L'Œ'}, {0xC9, L'æ'}, {0xCA, L'¡'}, {0xCB, L'¿'}};
...
std::wstring kh_to_c_string(uint8_t *input) {
	...
	while (*input) {
		uint8_t byte = *input++;
		auto it = c_to_kh.find(byte);
		output += (it != c_to_kh.end()) ? it->second : L' ';
	}
